...
t,r = HD17156b.radius(pmax = nps, steps = 1000)
...
t1,worb = HD17156b.ang_vel(pmax = nps, steps = 1000)
...
#for i in range(m):
days, d = HD17156b.DE(pmax = nps, NSIDE = 8, steps = 1000)
AllT = d[:,:,2]
    #AllT[i]= np.array(T)
...
F = HD17156b.Finc_hemi(pmax = nps, steps = 1000)
...
days, d, Fmap_wv, Fmap_wvpix, Fleavingwv, Ftotal = HD17156b.Fleaving(pmax = nps, steps = 1000, 
                                                   NSIDE=8, wavelenght= 8)
...
ax[4].set_ylabel("f ")
t,alpha, f = HD17156b.f_ratio(pmax = nps, steps = 1000)
ax[4].plot(t, f)
...
days, d, Fmapwvobs, weight, weightpix, Fwv = HD17156b.Fobs(pmax = nps, steps = 1000, 
                                                                             NSIDE = 8)
